        ...
        <div className={cx("list-songs")}>
            ...
            {/* <div className={cx("button-chords")}>
                ...
                <div className={cx("searchBox")}>
                    <input className={cx("searchInput")} style={{color: 'grey'}} type="text" placeholder="Search Beat..." />
                                ...
                                <div className={cx('song')} key={index}>
                                    ...
                                    <Popup trigger={<button className={cx("button-page")}>...</button>} position="bottom centers">
                                        <div className={cx("text-all")}>
                                            <div style={{ fontWeight: 500, fontSize: '2rem', padding: 5, display: 'flex', justifyContent: 'center' }}>
